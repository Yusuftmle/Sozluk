...
namespace BlazerSozluk.Infrastructure.Persistence.Context
{
    internal class SeedData
    {
        ...
        public async Task seedAsync(IConfiguration configuration)
        {
            ...
            var faker = new Faker<Entry>("tr")
                .RuleFor(i => i.Id, i => guids[counter++])  // counter'ı burada güvenli bir şekilde arttırın
                .RuleFor(i => i.CreateDate, i => i.Date.Between(DateTime.Now.AddDays(-100), DateTime.Now))
            ...
            var entries = faker.Generate(150);
            await context.Entries.AddRangeAsync(entries);



            var comments = new Faker<EntryComment>("tr")
                .RuleFor(i => i.Id, i => Guid.NewGuid())  // Her çağrıda yeni bir Guid üret
                .RuleFor(i => i.CreateDate, i => i.Date.Between(DateTime.Now.AddDays(-100), DateTime.Now))
                .RuleFor(i => i.Content, i => i.Lorem.Paragraph(2))
                .RuleFor(i => i.CreatedById, i => i.PickRandom(userIds))
