        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedById = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EntryCommentFavoriteId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EntryCommentFavorite_EntryCommentFavorite_EntryCommentFavoriteId",
                        column: x => x.EntryCommentFavoriteId,
                        principalSchema: "dbo",
                        principalTable: "EntryCommentFavorite",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EntryCommentFavorite_entrycomment_EntryId",
                        column: x => x.EntryId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EntryCommentFavorite_EntryCommentFavoriteId",
                schema: "dbo",
                table: "EntryCommentFavorite",
                column: "EntryCommentFavoriteId");

            migrationBuilder.CreateIndex(
                name: "IX_EntryCommentFavorite_EntryId",
                schema: "dbo",
                table: "EntryCommentFavorite",
                column: "EntryId");
